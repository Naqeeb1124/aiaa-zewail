        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              {/* Social Icons */}
              <a href="https://discord.gg/2xMQrCHdPd" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#5865F2]/10 text-[#5865F2] flex items-center justify-center hover:bg-[#5865F2] hover:text-white transition-all shadow-sm" title="Join our Discord">
              ...
              <a href="https://www.linkedin.com/company/aiaa-student-branch-zewail-city/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#0077b5]/10 text-[#0077b5] flex items-center justify-center hover:bg-[#0077b5] hover:text-white transition-all shadow-sm" title="Follow us on LinkedIn">
