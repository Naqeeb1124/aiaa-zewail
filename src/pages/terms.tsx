    ...
    <div className="min-h-screen bg-canvas font-sans text-ink">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        <div className="bg-white p-8 md:p-12 border border-line space-y-12">
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">2. Use License</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">3. User Accounts</h2>
            <p className="text-ink-soft leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">4. Code of Conduct</h2>
            <p className="text-ink-soft leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">5. Disclaimer</h2>
            <p className="text-ink-soft leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">6. Changes to Terms</h2>
            <p className="text-ink-soft leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-black text-ink mb-4 uppercase tracking-tight">7. Contact Us</h2>
            <p className="text-ink-soft leading-relaxed">
              If you have any questions about these Terms, please contact us at: <a href="mailto:aiaa@zewailcity.edu.eg" className="text-deep font-bold hover:text-growth transition-colors">aiaa@zewailcity.edu.eg</a>.
            </p>
          </section>
